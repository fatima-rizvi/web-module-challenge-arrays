var originalFlavors = ["Banana Nut Fudge",
   ...
   "Butterscotch Ribbon",
    ...
    let snackTime = ["popcorn", "hummus", "pomegranate", "nuts"] //made to test the function below
...
function getFlavorByIndex(array, position){
...
function removeFlavorByName(array, flavor) {
    let flavorPosition = array.indexOf(flavor);
    array.splice(flavorPosition,1);
    return array;
}
...
console.log(copy(originalFlavors,"newOriginalFlavors"));
